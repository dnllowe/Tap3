...
protected:
	...
	bool gameWon = false; //Whether player finished all 100 matches
	bool changeHeader = false; //Controls changing achievement header back to original after gameWon
	bool slowPoke = false;
	RushRelax();
